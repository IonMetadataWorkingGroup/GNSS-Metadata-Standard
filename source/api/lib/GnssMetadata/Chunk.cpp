 ...
 */
IonString Chunk::toString(const IonString & /*sFormat*/) const
{
	return IonString("Chunk toString not implemented yet.");
}
 ...
 */
size_t Chunk::FindObject(SearchItem::List& listResults, const IonString& sid, const AttributedObject& rparent, bool bExcludeReference, int nDepth) const
{
