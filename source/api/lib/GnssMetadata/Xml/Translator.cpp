 ...
 */
bool Translator::ReadAttributedObject(AttributedObject& aobj, Context& /*ctxt*/, const tinyxml2::XMLElement & elem, bool bIdAttributeRequired)
{
	// Grab the ID.
...
void Translator::WriteElement(const char* pszElemName, const char* pszValue, XMLElement* pcontainer, bool bRequired, const char* pszDefault)
{
...
void Translator::WriteElement(const char* pszElemName, size_t ivalue, XMLElement* pcontainer, bool bRequired, const size_t& iDefault)
{
...
void Translator::WriteElement(const char* pszElemName, double dvalue, XMLElement* pcontainer, bool bRequired, const char* pszFormat, const double& dDefault)
{
