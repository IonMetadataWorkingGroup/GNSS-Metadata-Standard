 ...
 */
IonString File::toString(const IonString & sFormat) const
{
 ...
 */
size_t File::FindObject(SearchItem::List& listResults, const IonString& sid, const AttributedObject& rparent, bool bExcludeReference, int nDepth) const
{
 ...
 * Returns a string representation of the object.
 */
IonString FileSet::toString(const IonString & sFormat) const
{
	return AttributedObject::toString(sFormat);
}
