 ...
 */
IonString System::toString(const IonString & sFormat) const
{
 ...
 */
size_t System::FindObject(SearchItem::List& listResults, const IonString& sid, const AttributedObject& rparent, bool bExcludeReference, int nDepth) const
{
