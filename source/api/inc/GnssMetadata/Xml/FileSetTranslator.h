...
#ifndef FILESETTRANSLATOR_H_H
#define FILESETTRANSLATOR_H_H
...
{
	/**
	* Class implements xml translation for FileSet Type.
	*/
	class FileSetTranslator : public Translator
	{
