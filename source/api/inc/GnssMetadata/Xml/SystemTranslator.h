...
#ifndef SYSTEMTRANSLATOR_H_H
#define SYSTEMTRANSLATOR_H_H
...
{
	/**
	* Class implements xml translation for System Type.
	*/
	class SystemTranslator : public Translator
	{
