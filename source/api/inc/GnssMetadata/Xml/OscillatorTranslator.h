...
#ifndef OSCILLATORTRANSLATOR_H_H
#define OSCILLATORTRANSLATOR_H_H
...
{
	/**
	 * Class implements XML translation for Oscillator Type.
	 */
	class OscillatorTranslator : public Translator
	{
	public:
		OscillatorTranslator();
