...
#ifndef LUMPTRANSLATOR_H_H
#define LUMPTRANSLATOR_H_H
...
{
	/**
	 * Class implements XML translation for Lump Type.
	 */
	class LumpTranslator : public Translator
	{
