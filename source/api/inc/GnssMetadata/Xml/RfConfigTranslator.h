...
#ifndef RFCONFIGTRANSLATOR_H_H
#define RFCONFIGTRANSLATOR_H_H
...
{
	/**
	* Class implements xml translation for RfConfig Type.
	*/
	class RfConfigTranslator : public Translator
	{
