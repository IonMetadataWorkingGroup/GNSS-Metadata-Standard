...
#ifndef CHUNKTRANSLATOR_H_H
#define CHUNKTRANSLATOR_H_H
...
{
	/**
	 * Class implements XML translation for Chunk Type.
	 */
	class ChunkTranslator : public Translator
	{
