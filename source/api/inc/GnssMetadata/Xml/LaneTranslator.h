...
#ifndef LANETRANSLATOR_H_H
#define LANETRANSLATOR_H_H
...
{
	/**
	 * Class implements XML translation for Lane Type.
	 */
	class LaneTranslator : public Translator
	{
