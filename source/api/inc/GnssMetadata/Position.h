...
namespace GnssMetadata
{
	...
	public:
		Position(double lat, double lon, double height) : _latitude(lat), _longitude(lon), _height(height) {}

		Position() : _latitude(0.0), _longitude(0.0), _height(0.0) {}

		Position(const Position& rhs) : _latitude(rhs._latitude), _longitude(rhs._longitude), _height(rhs._height) {}
