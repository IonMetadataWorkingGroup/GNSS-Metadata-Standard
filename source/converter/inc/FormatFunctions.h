...
namespace SampleFormatFunctions
{
	...
	//
	// Some thoughts:
	// - I have included both I and IQ extraction functions, rather than simply re-use the I-only case
	...
	//
	template<typename chunk_t, typename sample_base_t> void IF(sample_base_t (*encoderFunc)(const chunk_t*, uint32_t, uint32_t, uint32_t),
	        const chunk_t* pChunk, uint32_t chunkIndex, uint32_t residualBitIndex, uint32_t bitWidth, SampleSink* sampleSink)
	{
	...
	template<typename chunk_t, typename sample_base_t> void IFn(sample_base_t (*encoderFunc)(const chunk_t*, uint32_t, uint32_t, uint32_t),
	        const chunk_t* pChunk, uint32_t chunkIndex, uint32_t residualBitIndex, uint32_t bitWidth, SampleSink* sampleSink)
	{
		// how many bits into the chunk element is the I sample
		uint8_t shift = static_cast<uint8_t>(8 * sizeof(chunk_t) - residualBitIndex - bitWidth);
	...
	template<typename chunk_t, typename sample_base_t> void IQ(sample_base_t (*encoderFunc)(const chunk_t*, uint32_t, uint32_t, uint32_t),
	        const chunk_t* pChunk, uint32_t chunkIndex, uint32_t residualBitIndex, uint32_t bitWidth, SampleSink* sampleSink)
	{
	...
	template<typename chunk_t, typename sample_base_t> void IQn(sample_base_t (*encoderFunc)(const chunk_t*, uint32_t, uint32_t, uint32_t),
	        const chunk_t* pChunk, uint32_t chunkIndex, uint32_t residualBitIndex, uint32_t bitWidth, SampleSink* sampleSink)
	{
		uint8_t shiftFirst, shiftSecond;
		uint32_t chunkIndexFirst, chunkIndexSecond;
	...
	template<typename chunk_t, typename sample_base_t> void InQ(sample_base_t (*encoderFunc)(const chunk_t*, uint32_t, uint32_t, uint32_t),
	        const chunk_t* pChunk, uint32_t chunkIndex, uint32_t residualBitIndex, uint32_t bitWidth, SampleSink* sampleSink)
	{
		uint8_t shiftFirst, shiftSecond;
		uint32_t chunkIndexFirst, chunkIndexSecond;
	...
	template<typename chunk_t, typename sample_base_t> void InQn(sample_base_t (*encoderFunc)(const chunk_t*, uint32_t, uint32_t, uint32_t),
	        const chunk_t* pChunk, uint32_t chunkIndex, uint32_t residualBitIndex, uint32_t bitWidth, SampleSink* sampleSink)
	{
		uint8_t shiftFirst, shiftSecond;
		uint32_t chunkIndexFirst, chunkIndexSecond;
	...
	template<typename chunk_t, typename sample_base_t> void QI(sample_base_t (*encoderFunc)(const chunk_t*, uint32_t, uint32_t, uint32_t),
	        const chunk_t* pChunk, uint32_t chunkIndex, uint32_t residualBitIndex, uint32_t bitWidth, SampleSink* sampleSink)
	{
		uint8_t shiftFirst, shiftSecond;
		uint32_t chunkIndexFirst, chunkIndexSecond;
	...
	template<typename chunk_t, typename sample_base_t> void QIn(sample_base_t (*encoderFunc)(const chunk_t*, uint32_t, uint32_t, uint32_t),
	        const chunk_t* pChunk, uint32_t chunkIndex, uint32_t residualBitIndex, uint32_t bitWidth, SampleSink* sampleSink)
	{
		uint8_t shiftFirst, shiftSecond;
		uint32_t chunkIndexFirst, chunkIndexSecond;
	...
	template<typename chunk_t, typename sample_base_t> void QnI(sample_base_t (*encoderFunc)(const chunk_t*, uint32_t, uint32_t, uint32_t),
	        const chunk_t* pChunk, uint32_t chunkIndex, uint32_t residualBitIndex, uint32_t bitWidth, SampleSink* sampleSink)
	{
		uint8_t shiftFirst, shiftSecond;
		uint32_t chunkIndexFirst, chunkIndexSecond;
	...
	template<typename chunk_t, typename sample_base_t> void QnIn(sample_base_t (*encoderFunc)(const chunk_t*, uint32_t, uint32_t, uint32_t),
	        const chunk_t* pChunk, uint32_t chunkIndex, uint32_t residualBitIndex, uint32_t bitWidth, SampleSink* sampleSink)
	{
		uint8_t shiftFirst, shiftSecond;
		uint32_t chunkIndexFirst, chunkIndexSecond;
	...
	template<typename chunk_t, typename sample_base_t> void Int8IQ(sample_base_t (*encoderFunc)(const chunk_t*, uint32_t, uint32_t, uint32_t),
	        const chunk_t* pChunk, uint32_t chunkIndex, uint32_t residualBitIndex, uint32_t bitWidth, SampleSink* sampleSink)
	{
		uint8_t shiftFirst, shiftSecond;
		uint32_t chunkIndexFirst, chunkIndexSecond;
