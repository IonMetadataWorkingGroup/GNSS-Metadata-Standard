# GNSS-Metadata-Standard
  ...
  Windows:  [![Build status](https://ci.appveyor.com/api/projects/status/7oy9xv60ko04gfub/branch/trevor?svg=true)](https://ci.appveyor.com/project/JamesTCurran/gnss-metadata-standard/branch/trevor)
